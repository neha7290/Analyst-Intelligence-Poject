...
class SourceTablePage {
    constructor(page) {
        ...
        const UpdateFileName = `Current Headcount${Date.now()}`;
        ...
        this.Salary = page.locator("//div[@class='MuiBox-root jss106']//*[name()='svg']");
        // this.Bonus = page.locator("//div[@class='MuiBox-root jss107']//*[name()='svg']");
        this.Bonus = page.locator("(//*[name()='path'])[11]");
        this.Commision = page.locator("(//*[name()='path'])[12]");
    ...
    async CustomizeAndImport() {
        ...
        await this.CUSTOM_COLUMN.click({ modifiers: ['Shift'] });
